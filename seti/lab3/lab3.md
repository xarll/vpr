...
- Для оценки <<хз>> модель MUA -> MTA -> MUA: 1 сервер и 2 клиента => всего 3 машины. (в разработке)
...
Если есть полезная информация, прошу в [VK](https://vk.com/jkearnsl)
...
После установки ОС нужно послать сингнал завершения работы и клонировать машину 2 раза, чтобы получилось 3 машины(если вы выбрали первые 2 модели):
...
Соберем информацию о 3х машинах в столбик (полезно для первых 2х моделей)
...
Дадим разрешение на отправку почты от наших клиентов(ВМ "mail-client" и "mail-client2"), прописав<br>
