...
Для серверной ВМ (в моем случае "mail-server") следует установить следующие компоненты:
...
Следующий пункт для этого

### Временное включение интернета
- установим пару компонентов, но для начала включим интернет на время установки:
