...
Если у вас возникает ошибка у клиента, связанная с `recvbuf`, то возможно вы передали слишком много информации за раз и Ваш буфер забит. Советую что-то сделать, переписать на более универсальны вид или просто увеличить значение буфера до 60000(к примеру)
