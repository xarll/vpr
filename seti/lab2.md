...
- Иногда опущенные интерфейсы сами поднимаются. Если вдруг поднимаются, то опускаем их снова
...
Теперб давайте попробовать пропинговатья с ВМ 1 на ВМ 3
IP у нас у ВМ 3 только один, проблем с определением быть не должно

А проблемы с пингом нормальны. Если их нет, всё раввно продолжаем делать далле лабу
...
### Теперь пропипишем маршрут на ВМ 3

Все дальнейшие действия на ВМ 3

1. Пропингуем ВМ 2
2. Пинга нету, всё ок. Пинг есть, читаем инструкцию заново и переделываем. Возможно стоит [почитать](./lab2.md#особенности-использования-ubuntu)
3. Теперь пропишем новый маршрут на ВМ 3
