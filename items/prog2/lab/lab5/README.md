...
<details>
  <summary>Task8/SupaCoin.java</summary>
  
  Препод разрешил сделать вот так
...
public class SupaCoin {
    ...
    public static void main(String[] args) {
        ...
        dList.add(5, minCoins(denominations2, 5));
        System.out.println("[1] Минимальное кол-во монет для " + 3 + " рублей: " + dList.getByKey(3).values());
        System.out.println("[2] Минимальное кол-во монет для " + 5 + " рублей: " + dList.getByKey(5).values());
    }
}
