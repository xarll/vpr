...
Некоторые операции требуют прав суперпользователя, в связи с чем, рекомендую всё делать из под `sudo`, лучше сразу прописать `sudo su`
...
От себя советую MUA -> MTA -> MTA - по ней получите 5ть.<br>
Если у Вас есть полезная информация, милости прошу в [VK](https://vk.com/jkearnsl).


*Авторство: **Бояршинов Н., Горшков В.***
