...
<details>
  ...
  Если используете какое-либо IDE для python, то включите поддержку эмуляции консоли, как показано на примере pycharm:
...
PS: программа местами забита хардкодом, если есть притензии, то открывайте Issues
