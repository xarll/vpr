...
- Из состояния S0 можно попасть в S1 через эпсилон, в S2 через b, и в S3 через a.
- Из S1 можно попасть в S3 через a, в S2 через b, но нельзя попасть ни в одно состояние через эпсилон.
