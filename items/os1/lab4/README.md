...
Во время сдачи Долгов смотрел просто все скрипты из [2 пункта]()

Также, Долгов может заметить что скрипты по стилю одинаковы. Поэтому я прилагаю `Аналоги` под спойлером. Зачатсую они более прсотые. Берите разные, миксуйте, почувствуйте себя диджеем (^人<)〜☆
